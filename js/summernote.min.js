! function (a) {
    ...
    var b = navigator.appVersion.indexOf("Mac") > -1,
        ...
        f = function () {
            var a = function (a) {
                return a[0]
                    ...
                    return b = b || e.self, a.reduce(function (a, c) {
                        return a + b(c)
                    }, 0)
                }, g = function (a) {
        ...
        g = function () {
            var b = function (a) {
                ...
                s = function (a) {
                    ...
                    var d = f.initial(k(c, e.eq(b)));
                    return a.map(d, t).reverse()
                }, v = function (a, b) {
                    ...
                    var d = k(b, e.eq(a));
                    return 1 === d.length ? w(b, c) : d.reduce(function (a, d) {
                        var e = d.cloneNode(!1);
                    ...
                    return g.isTextarea(a[0]) ? z(a.val()) : a.html()
                };
            return {
                isText: r,
                isPara: c,
            ...
            var b = !! document.createRange,
                c = function (a, b) {
                    ...
                    if (0 != c && g.isText(i[c - 1])) {
                        ...
                        k.nodeValue, b && k.nextSibling && g.isText(k.nextSibling) && m == k.nodeValue.length && (m -= k.nodeValue.length, k = k.nextSibling), e = k, c = m
                    }
                    return {
                        cont: e,
                        offset: c
                    ...
                    var b = function (a, c) {
                        var d, h;
                        if (g.isText(a)) {
                            var i = g.listPrev(a, e.not(g.isText)),
                                j = f.last(i).previousSibling;
                            d = j || a.parentNode, c += f.sum(f.tail(i), g.length), h = !j
                        } else {
                            if (d = a.childNodes[c] || a, g.isText(d)) return b(d, c);
                            c = 0, h = !1
                        }
                        return {
                            cont: d,
                    ...
                    this.select = function () {
                        ...
                        var b = g.listBetween(c, i),
                            d = f.compact(a.map(b, function (a) {
                                return g.ancestor(a, g.isPara)
                            }));
                        return a.map(f.clusterBy(d, e.eq2), f.head)
                    };
                    var l = function (a) {
                        return function () {
        ...
        i = function () {
            ...
            }, f = ["bold", "italic", "underline", "strikethrough", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "insertOrderedList", "insertUnorderedList", "indent", "outdent", "formatBlock", "removeFormat", "backColor", "foreColor", "insertImage", "insertHorizontalRule"], j = 0, k = f.length; k > j; j++) this[f[j]] = function (a) {
                return function (b, c) {
                    e(b), document.execCommand(a, !1, c)
                }
            }(f[j]);
            this.formatBlock = function (a, b) {
                e(a), b = c ? "<" + b + ">" : b, document.execCommand("FormatBlock", !1, b)
            }, this.fontSize = function (a, b) {
                e(a), document.execCommand("fontSize", !1, 3), d ? a.find("font[size=3]").removeAttr("size").css("font-size", b + "px") : a.find("span").filter(function () {
                    return "medium" == this.style.fontSize
                }).css("font-size", b + "px")
            }, this.lineHeight = function (a, c) {
                e(a), b.stylePara(h.create(), {
                    lineHeight: c
                })
                ...
                d({
                    ...
                    var g = -1 !== d.toLowerCase().indexOf("://"),
                        i = g ? d : "" + d;
                    if (c && f.isCollapsed()) {
                        f.insertNode(a('<embed width="420" height="345" src="' + d + '" type="application/x-shockwave-flash"></embed>')[0]);
                        f = h.create(j[0], 0, j[0], 1), f.select()
                    } else {
                        d = d.replace("http://youtu.be/","")
                        d = d.replace("http://www.youtube.com/watch?v=","")
                    	f.insertNode(a('<iframe class="youtube-player" type="text/html" width="640" height="385" src="http://www.youtube.com/embed/' + d + '" allowfullscreen frameborder="0"></iframe>')[0]);
            ...
            }, this.insertTable = function (b, d) {
                e(b);
                for (var f, g = d.split("x"), i = g[0], j = g[1], k = [], l = c ? "&nbsp;" : "<br/>", m = 0; i > m; m++) k.push("<td>" + l + "</td>");
                f = k.join("");
            ...
            },this.showYoutubeDialog = function (a, b, c) {
                var d = a.find(".note-youtube-dialog"),
                	b = d.find(".note-youtube-text"),
                    f = d.find(".note-youtube-url"),
                    g = d.find(".note-youtube-btn");
                d.on("shown.bs.modal", function () {
            ...
            var c = new k,
                ...
                i = {
                    ...
                    b.trigger("focus"), j.onImageUpload ? j.onImageUpload(d, c, b) : a.each(d, function (a, d) {
                    ...
                    var b = p(a.currentTarget || a.target),
                        g = c.currentStyle(a.target);
                    g && (d.update(b.toolbar(), g), e.update(b.popover(), g), f.update(b.handle(), g))
                }, v = function (a) {
                    var b = p(a.currentTarget || a.target);
                    e.hide(b.popover()), f.hide(b.handle())
                }, w = function (b) {
                    ...
                    if (e.length > 0) {
                        var f, g = e.attr("data-event"),
                            ...
                            l = j.editable(),
                            m = j.codable();
                        if (-1 !== a.inArray(g, ["resize", "floatMe"])) {
                            var n = j.handle(),
                        ...
                        else if ("showYoutubeDialog" === g) c.setYoutubeDialog(l, function (a, b) {
                            h.showYoutubeDialog(k, a, b)
                        });
            ...
            this.attach = function (a, b) {
                ...
                }), b.onfocus && a.editable.focus(b.onfocus), b.onblur && a.editable.blur(b.onblur), b.onkeyup && a.editable.keyup(b.onkeyup), b.onkeydown && a.editable.keydown(b.onkeydown), b.onImageUpload && (j.onImageUpload = b.onImageUpload)
            }, this.dettach = function (a) {
                a.editable.off(), a.toolbar.off(), a.handle.off(), a.popover.off()
            }
        }, q = function () {
            var c = {
            	youtube: '<button type="button" class="btn btn-default btn-sm btn-small" title="Youtube" data-event="showYoutubeDialog" tabindex="-1"><i class="fa fa-youtube-play"></i></button>',
            ...
            this.createLayout = function (b, f, h, i) {
                if (!b.next().hasClass("note-editor")) {
                    var k = a('<div class="note-editor"></div>');
                    f > 0 && a('<div class="note-statusbar"><div class="note-resizebar"><div class="note-icon-bar"></div><div class="note-icon-bar"></div><div class="note-icon-bar"></div></div></div>').prependTo(k);
                    var l = a('<div class="note-editable" contentEditable="true"></div>').prependTo(k);
                    f && l.height(f), h && l.data("tabsize", h), l.html(g.html(b)), l.data("NoteHistory", new j), a('<textarea class="note-codable"></textarea>').prependTo(k), setTimeout(function () {
                        document.execCommand("styleWithCSS", 0, !0)
                    });
                    for (var o = "", q = 0, r = i.length; r > q; q++) {
                        var s = i[q];
    ...
    a.fn.extend({
        ...
        code: function (b) {
            if (void 0 === b) {
                var c = this.first();
                if (0 == c.length) return;
                var d = r.layoutInfoFromHolder(c);
                if (d && d.editable) {
                    var e = d.editor.hasClass("codeview");
                    return e ? d.codable.val() : d.editable.html()
                }
                return c.html()
            }
